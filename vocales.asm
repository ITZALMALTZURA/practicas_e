...
msj2 db 13,10,'Digite Cadena minuscula: $' 
...
mov bx,0000h    ;es la esquina superior izquierda reglon: columna
lea SI,cadena1 
mov cx,50 


  regresa: mov ah,07h    ;peticion de leer caracter
    int 21h 
    cmp al,13 
    je termina 
    ...
    mov dl,al 
    mov ah,02h    ;interupcion no enmascarable
    int 21h 
  loop regresa 
...
mov cl,0h
mov ah,02       
       ;aun tenemos el numero de el arreglo
